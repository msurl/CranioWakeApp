  ...
  public FourSquareDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFourSquareGame = new EntityInsertionAdapter<FourSquareGame>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `four_square_table` (`FourSquareId`,`pictureName`,`answerSquare1`,`answerSquare2`,`answerSquare3`,`answerSquare4`,`dateTime`,`fkOperationId`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
