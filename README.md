...
Die generierte Datei befindet sich nach Abschluss des Exports unter dem Pfad: Android/data/data/com.app.craniowake/files/Craniowake/backup im internen Speicher der eigenen Dateien auf dem Android Endgerät.
